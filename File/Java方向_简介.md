...
Java和C语言/C的语法比较相近，学过C/C的佬佬可以很容易上手。同时Java摈弃了一些C++中令人迷惑的特性~~（再也不用为指针而掉头发啦）~~，还提供自动的内存管理等，轻松易用👍。
...
基于Java的Web开发组件有很多，比如官方的servlet、JSP，以及非常流行的Spring、Hibernate等，可以说Java在web世界拥有举足轻重的地位，Google、Facebook、淘宝、百度等网站均使用Java支持。
...
Java出题组的三位出题人分别设置了基础语法/面向对象思想，反射/多线程，...相关题目，每个任务页面下方有出题人信息，如果有疑问欢迎私戳出题人❤！
